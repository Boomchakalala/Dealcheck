 ...
 */
export function MarketBenchmark({ benchmark: b, interpretation, fmt, locale }: Props) {
  const fr = locale === 'fr'
    ...
    <section id="benchmark" className="scroll-mt-[196px]">
      <div className="flex flex-wrap items-center gap-3 mb-4">
        ...
        <div className="min-w-0 flex-1">
          <p className="tl-label text-[11.5px] text-green-deep mb-0.5">{fr ? 'Étape 2 · Analyse complète' : 'Step 2 · Full Analysis'}</p>
