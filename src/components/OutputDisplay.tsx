      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5">
            ...
            <p className="text-xs text-slate-600 mb-3">Click to read and copy</p>
            <div className="space-y-2.5">
              <button
                onClick={() => setSelectedEmail('neutral')}
                className="w-full p-4 bg-gradient-to-br from-blue-50 to-blue-50/50 border-2 border-blue-200 rounded-lg hover:border-blue-300 transition-all text-left group"
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs font-bold text-blue-900">Draft 1 — Neutral</span>
                ...
                <p className="text-xs text-blue-800 line-clamp-2 leading-relaxed">{output.email_drafts.neutral.subject}</p>
              </button>

              <button
                onClick={() => setSelectedEmail('firm')}
                className="w-full p-4 bg-gradient-to-br from-amber-50 to-amber-50/50 border-2 border-amber-200 rounded-lg hover:border-amber-300 transition-all text-left group"
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs font-bold text-amber-900">Draft 2 — Firm</span>
                ...
                <p className="text-xs text-amber-800 line-clamp-2 leading-relaxed">{output.email_drafts.firm.subject}</p>
              </button>

              <button
                onClick={() => setSelectedEmail('final')}
                className="w-full p-4 bg-gradient-to-br from-red-50 to-red-50/50 border-2 border-red-200 rounded-lg hover:border-red-300 transition-all text-left group"
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs font-bold text-red-900">Draft 3 — Final Push</span>
                ...
                <p className="text-xs text-red-800 line-clamp-2 leading-relaxed">{output.email_drafts.final_push.subject}</p>
              </button>
            </div>

            <div className="mt-4 pt-4 border-t border-slate-200">
              <p className="text-xs text-slate-600 leading-relaxed">
                <span className="font-semibold text-slate-700">Tip:</span> Always ask for a discount, even if pricing seems fair. Most vendors have room to move.
              </p>
            </div>
          </div>
