...
export const metadata: Metadata = {
  title: 'Help & FAQ',
  description: 'Frequently asked questions about TermLift. How vendor quote analysis works, supported file formats, Full Analysis, data privacy, and the success-based negotiation service.',
  openGraph: {
...
const faqItems = [
  { q: "What is TermLift?", a: "TermLift helps you negotiate better supplier deals. Upload a quote and get a fast initial assessment — deal score, red flags, and potential savings. From there, unlock Full Analysis for deeper negotiation levers, recommended asks, and strategy — then negotiate the deal yourself, or have TermLift negotiate it for you." },
  ...
  { q: "What do I get back from an analysis?", a: "First, a fast initial assessment — a deal score, red flags, and an estimate of potential savings. From there, Full Analysis goes deeper: negotiation levers, recommended asks, priorities, and strategy, plus a ready-to-send negotiation email once you're ready to act." },
