      ...
      <main className="flex-1">
        <div className="relative overflow-hidden px-6 pt-20 sm:pt-24 pb-12 bg-[#FAFAF7] border-b border-slate-100">
          ...
          <div className="relative max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 mb-5">
              ...
              <span className="text-[12px] font-bold tracking-widest uppercase text-emerald-600" style={{ fontFamily: "'JetBrains Mono', monospace" }}>{t('termsPage.badge')}</span>
            </div>
            ...
            <p className="text-[13px] text-slate-400">{t('termsPage.lastUpdated')}</p>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto px-5 sm:px-8 py-12 pb-20">
          <div className="space-y-10 text-sm text-slate-700 leading-relaxed">
            ...
            {/* 1. Acceptance */}
            <section>
              <h2 className="text-lg font-semibold text-slate-900 mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>{t('termsPage.s1Title')}</h2>
              <p>{t('termsPage.s1Text')}</p>
            </section>

            {/* 2. What the Service Is */}
            <section>
              <h2 className="text-lg font-semibold text-slate-900 mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>{t('termsPage.s2Title')}</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-slate-900 mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>{t('termsPage.s3Title')}</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-slate-900 mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>{t('termsPage.s4Title')}</h2>
            ...
            {/* 5. Pricing & Payment */}
            <section>
              <h2 className="text-lg font-semibold text-slate-900 mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>{t('termsPage.s5Title')}</h2>
              ...
              <div className="space-y-3 mb-4">
                ...
                <div className="bg-slate-50 rounded-lg border border-slate-200 p-4">
                  <p className="font-medium text-slate-900 mb-1">{t('termsPage.s5EssentialsTitle')}</p>
                  <p className="text-sm">{t('termsPage.s5EssentialsDesc')}</p>
                </div>

                <div className="bg-slate-50 rounded-lg border border-slate-200 p-4">
                  <p className="font-medium text-slate-900 mb-1">{t('termsPage.s5ProTitle')}</p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-slate-900 mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>{t('termsPage.s6Title')}</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-slate-900 mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>{t('termsPage.s7Title')}</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-slate-900 mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>{t('termsPage.s8Title')}</h2>
              <ul className="space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-lg font-semibold text-slate-900 mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>{t('termsPage.s9Title')}</h2>
            ...
            {/* 10. Indemnification */}
            <section>
              <h2 className="text-lg font-semibold text-slate-900 mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>{t('termsPage.s10Title')}</h2>
              <p>{t('termsPage.s10Text')}</p>
            </section>

            {/* 11. Dispute Resolution */}
            <section>
              <h2 className="text-lg font-semibold text-slate-900 mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>{t('termsPage.s11Title')}</h2>
              <ul className="space-y-2 ml-4">
            ...
            <section>
              <h2 className="text-lg font-semibold text-slate-900 mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>{t('termsPage.s12Title')}</h2>
              <p>{t('termsPage.s12Text')}</p>
            </section>

            {/* 13. General */}
            <section>
              <h2 className="text-lg font-semibold text-slate-900 mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>{t('termsPage.s13Title')}</h2>
              <ul className="space-y-2 ml-4">
            ...
            {/* 14. Contact */}
            <section>
              <h2 className="text-lg font-semibold text-slate-900 mb-3" style={{ fontFamily: "'Sora', sans-serif" }}>{t('termsPage.s14Title')}</h2>
