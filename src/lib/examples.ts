...
[Your Name]`,
  ...
  score: 62,
  score_label: "Mostly fair, a few points to tighten",
  score_breakdown: {
    pricing_fairness: 28,
    terms_protections: 20,
    leverage_position: 14,
    pricing_deductions: [
      { points: 12, reason: "15 of 40 seats/units unused — 37% waste" },
      { points: 6, reason: "No loyalty discount on renewal" },
      { points: 4, reason: "Savings potential above 20%" },
    ],
    terms_deductions: [
      { points: 6, reason: "Auto-renewal with only 30-day notice period" },
      { points: 4, reason: "Price escalation clause with 8% cap" },
    ],
    leverage_deductions: [
...
[Your Name]`,
  ...
  score: 48,
  score_label: "Several issues to address",
  score_breakdown: {
    pricing_fairness: 17,
    terms_protections: 15,
    leverage_position: 15,
    pricing_deductions: [
      { points: 15, reason: "12 of 40 seats/units unused — 30% waste" },
      { points: 10, reason: "No multi-year discount on renewal" },
      { points: 8, reason: "Savings potential above 20%" },
    ],
    terms_deductions: [
      { points: 10, reason: "Auto-renewal with 90-day notice period" },
      { points: 5, reason: "Price escalation allowed with no cap" },
    ],
    leverage_deductions: [
      { points: 5, reason: "Annual/upfront payment with no visible discount" },
    ],
...
[Your Name]`,
  ...
  score: 84,
  score_label: "Low risk, minor improvements possible",
  score_breakdown: {
    pricing_fairness: 46,
    terms_protections: 22,
    leverage_position: 16,
    pricing_deductions: [
      { points: 4, reason: "Savings potential above 3%" },
    ],
    terms_deductions: [
      { points: 5, reason: "Auto-renewal with only 30-day notice period" },
      { points: 3, reason: "Price escalation allowed with no cap" },
    ],
    leverage_deductions: [
...
[Your Name]`,
  ...
  score: 35,
  score_label: "Significant concerns found",
  score_breakdown: {
    pricing_fairness: 15,
    terms_protections: 12,
    leverage_position: 14,
    pricing_deductions: [
      { points: 15, reason: "Vendor appears to be an intermediary" },
      { points: 12, reason: "Savings potential above 20%" },
      { points: 8, reason: "Price escalation clause with no cap" },
    ],
    terms_deductions: [
      { points: 10, reason: "No exit clause on a 12 months contract" },
      { points: 5, reason: "No SLA or service level defined" },
    ],
    leverage_deductions: [
...
[Your Name]`,
  ...
  score_breakdown: {
    ...
    pricing_deductions: [
      { points: 15, reason: "Vendor appears to be an intermediary" },
      { points: 10, reason: "Savings potential above 15%" },
    ],
    terms_deductions: [
      { points: 12, reason: "No exit clause on a 36 months contract" },
      { points: 5, reason: "Exclusivity clause — removes pricing leverage" },
      { points: 3, reason: "Auto-renewal with 90-day notice period" },
    ],
    leverage_deductions: [
      { points: 6, reason: "Tight signing deadline" },
    ],
...
[Your Name]`,
  ...
  score_breakdown: {
    ...
    leverage_position: 14,
    pricing_deductions: [
      { points: 15, reason: "Savings potential above 13%" },
    ],
    terms_deductions: [
      { points: 10, reason: "No SLA or service level defined" },
      { points: 5, reason: "Significant commitment with vaguely defined scope" },
    ],
    leverage_deductions: [],
  },
