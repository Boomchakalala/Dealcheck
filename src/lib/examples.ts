...
[Your Name]`,
  ...
  score: 42,
  score_label: "Overpriced",
  score_breakdown: {
    pricing_fairness: 18,
    terms_protections: 12,
    leverage_position: 12,
  },
  score_rationale: "20% ad management fee is double the industry standard, and the retainer sits above market for this scope.",
  assumptions: [
...
[Your Name]`,
  ...
  score_breakdown: {
    ...
    leverage_position: 18,
  },
  score_rationale: "Paying for 12 unused seats at full price and no multi-year discount on a renewal — strong leverage not being used.",
  assumptions: [
...
[Your Name]`,
  ...
  score_rationale: "Pricing is reasonable but the delivery fee structure and lack of volume tier optimization leave €5,600/year on the table.",
  assumptions: [
