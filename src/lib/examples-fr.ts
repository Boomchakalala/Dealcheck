...
[Votre Nom]`,
  ...
  score: 42,
  score_label: "Surcoté",
  score_breakdown: { pricing_fairness: 18, terms_protections: 12, leverage_position: 12 },
  score_rationale: "Les frais de gestion publicitaire à 20 % sont le double du standard, et le mandat est au-dessus du marché.",
  assumptions: [
...
[Votre Nom]`,
  ...
  score: 55,
  score_label: "Surcoté",
  score_breakdown: { pricing_fairness: 22, terms_protections: 15, leverage_position: 18 },
  score_rationale: "12 licences inutilisées au plein tarif et aucune remise pluriannuelle sur un renouvellement — le levier n'est pas exploité.",
  assumptions: [
...
[Votre Nom]`,
  ...
  score: 63,
  score_label: "Marge de négociation",
  score_breakdown: { pricing_fairness: 30, terms_protections: 18, leverage_position: 15 },
  score_rationale: "Les tarifs sont corrects mais les frais de livraison et l'absence d'optimisation volume laissent 5 600 €/an sur la table.",
  assumptions: [
