...
[Votre nom]`,
  ...
  score: 62,
  score_label: "Globalement correct, quelques points \u00e0 ajuster",
  score_breakdown: {
    pricing_fairness: 20,
    terms_protections: 16,
    leverage_position: 15,
    pricing_deductions: [
      { points: 15, reason: "15 des 40 licences inutilisées — 37 % de gaspillage" },
      { points: 10, reason: "Aucune remise fidélité au renouvellement" },
      { points: 5, reason: "Potentiel d'économies supérieur à 20 %" },
    ],
    terms_deductions: [
      { points: 8, reason: "Renouvellement automatique avec préavis de 30 jours" },
      { points: 6, reason: "Clause d'augmentation plafonnée à 8 %" },
    ],
    leverage_deductions: [
      { points: 5, reason: "Paiement annuel d'avance sans remise visible" },
    ],
  },
  score_rationale: "3 problèmes identifiés. Points clés : 15 licences sur 40 inutilisées, renouvellement automatique avec préavis de 30 jours. Économies potentielles : 25 % du total.",
  assumptions: [
...
[Votre nom]`,
  ...
  score: 48,
  score_label: "Plusieurs points \u00e0 revoir",
  score_breakdown: {
    pricing_fairness: 17,
    terms_protections: 15,
    leverage_position: 15,
    pricing_deductions: [
      { points: 15, reason: "12 des 40 licences inutilisées — 30 % de gaspillage" },
      { points: 10, reason: "Aucune remise pluriannuelle au renouvellement" },
      { points: 8, reason: "Potentiel d'économies supérieur à 20 %" },
    ],
    terms_deductions: [
      { points: 10, reason: "Renouvellement automatique avec préavis de 90 jours" },
      { points: 5, reason: "Clause d'augmentation sans plafond" },
    ],
    leverage_deductions: [
      { points: 5, reason: "Paiement annuel d'avance sans remise visible" },
    ],
  },
  score_rationale: "4 problèmes identifiés. Points clés : 12 licences sur 40 inutilisées, clause d'augmentation sans plafond. Économies potentielles : 20 % du total.",
  assumptions: [
...
[Votre nom]`,
  ...
  score: 84,
  score_label: "Risque faible, am\u00e9liorations mineures possibles",
  score_breakdown: {
    pricing_fairness: 46,
    terms_protections: 22,
    leverage_position: 16,
    pricing_deductions: [
      { points: 4, reason: "Potentiel d'\u00e9conomies sup\u00e9rieur \u00e0 3 %" },
    ],
    terms_deductions: [
      { points: 5, reason: "Renouvellement automatique avec pr\u00e9avis de 30 jours" },
      { points: 3, reason: "Clause d'augmentation sans plafond" },
    ],
    leverage_deductions: [
      { points: 4, reason: "Paiement annuel d'avance sans remise visible" },
    ],
  },
  score_rationale: "2 probl\u00e8mes identifi\u00e9s. \u00c9conomies potentielles : 3 % du total.",
  assumptions: [
...
[Votre nom]`,
  ...
  score: 35,
  score_label: "Probl\u00e8mes significatifs identifi\u00e9s",
  score_breakdown: {
    pricing_fairness: 15,
    terms_protections: 12,
    leverage_position: 14,
    pricing_deductions: [
      { points: 15, reason: "Intermédiaire identifié" },
      { points: 12, reason: "Potentiel d'économies supérieur à 20 %" },
      { points: 8, reason: "Clause d'augmentation sans plafond" },
    ],
    terms_deductions: [
      { points: 10, reason: "Aucune clause de sortie sur un contrat de 12 mois" },
      { points: 5, reason: "Aucun SLA défini" },
    ],
    leverage_deductions: [
      { points: 6, reason: "Délai de signature serré" },
    ],
  },
  score_rationale: "5 problèmes identifiés. Points clés : clause d'augmentation sans plafond, aucune clause de sortie. Économies potentielles : 23 % du total.",
  assumptions: [
...
[Votre nom]`,
  ...
  score_breakdown: {
    ...
    pricing_deductions: [
      { points: 15, reason: "Intermédiaire identifié" },
      { points: 10, reason: "Potentiel d'économies supérieur à 15 %" },
    ],
    terms_deductions: [
      { points: 12, reason: "Aucune clause de sortie sur un contrat de 36 mois" },
      { points: 5, reason: "Clause d'exclusivité — supprime le levier tarifaire" },
      { points: 3, reason: "Renouvellement automatique avec préavis de 90 jours" },
    ],
    leverage_deductions: [
      { points: 6, reason: "Délai de signature serré" },
    ],
  },
  score_rationale: "5 problèmes identifiés. Points clés : aucune clause de sortie sur 36 mois, clause d'exclusivité. Économies potentielles : 16 % du total.",
  assumptions: [
...
[Votre nom]`,
  ...
  score_breakdown: {
    ...
    leverage_position: 14,
    pricing_deductions: [
      { points: 15, reason: "Potentiel d'économies supérieur à 13 %" },
    ],
    terms_deductions: [
      { points: 10, reason: "Aucun SLA défini" },
      { points: 8, reason: "Engagement significatif avec périmètre vaguement défini" },
    ],
    leverage_deductions: [],
  },
  score_rationale: "3 problèmes identifiés. Points clés : aucun SLA défini, périmètre vaguement défini. Économies potentielles : 13 % du total.",
  assumptions: [
