...
export const marketingAgencyExampleFr: DealOutput = {
  ...
  red_flags: [
    ...
    },
    {
      ...
      why_it_matters: "Vous surpayez de €1,500/mois par rapport aux agences comparables (6 000–6 500 €/mois pour ce périmètre). Soit jusqu'à €18,000/an au-dessus du marché.",
  ...
  negotiation_plan: {
    leverage_you_have: [
      ...
      "Envisagez d'obtenir des devis concurrents — les agences comparables facturent généralement 6 000–6 500 €/mois",
    ],
    must_have_asks: [],
    nice_to_have_asks: [],
...
[Votre Nom]`,
  ...
  score_breakdown: {
    ...
    pricing_deductions: [
      { points: 15, reason: "Frais de gestion à 20 % — le double du standard" },
      { points: 8, reason: "Mandat à 7 500 €/mois — au-dessus du marché" },
      { points: 5, reason: "Économies > 15 % de la valeur du contrat" },
      { points: 3, reason: "Négociation standard nécessaire" },
    ],
    terms_deductions: [
      { points: 10, reason: "Préavis de résiliation de 60 jours" },
    ],
    leverage_deductions: [
      { points: 5, reason: "Paiement anticipé requis" },
      { points: 2, reason: "Nouveau fournisseur — moins de levier" },
    ],
  },
  score_rationale: "Frais de gestion publicitaire à 20 % — le double du standard",
  assumptions: [
...
[Votre Nom]`,
  ...
  score_breakdown: {
    ...
    pricing_deductions: [
      ...
      { points: 8, reason: "Aucune remise pluriannuelle sur un renouvellement" },
      { points: 10, reason: "Économies > 26 % de la valeur du contrat" },
    ],
    terms_deductions: [
      { points: 10, reason: "Renouvellement automatique avec préavis de 90 jours" },
      { points: 5, reason: "Augmentation annuelle jusqu'à 8 %" },
    ],
    leverage_deductions: [
      { points: 5, reason: "Paiement annuel anticipé" },
    ],
  },
  score_rationale: "12 licences inutilisées au plein tarif sans remise pluriannuelle",
  assumptions: [
...
[Votre Nom]`,
  ...
  score_breakdown: {
    ...
    pricing_deductions: [
      { points: 8, reason: "Aucune remise volume à ce niveau de dépenses" },
      { points: 5, reason: "Économies > 12 % de la valeur du contrat" },
      { points: 3, reason: "Négociation standard nécessaire" },
    ],
    terms_deductions: [
      { points: 5, reason: "Renouvellement automatique sans clause de sortie" },
      { points: 3, reason: "Frais de livraison non transparents" },
    ],
    leverage_deductions: [
      { points: 4, reason: "Engagement de 24 mois" },
    ],
  },
  score_rationale: "Frais de livraison et absence d'optimisation volume laissent 5 600 €/an sur la table",
  assumptions: [
